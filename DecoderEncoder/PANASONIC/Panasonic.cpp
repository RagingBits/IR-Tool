...
#define HEADER_ON_SIZE (3400)
#define HEADER_OFF_SIZE (1600)
...
static std::string encode(int argc, char* argv[])
{
    ...
    if (argc == 2)
    {
            ...
            if ((address >= 0 && address <= 0xFFFF) && (command >= 0 && command <= 0xFFFFFFFF))
            {
